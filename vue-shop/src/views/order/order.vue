    ...
    <div class="content-container" direction="vertical">
        ...
        <div>
            ...
            @selection-change="handleSelectionChange">
                ...
                width="200">
                    <template #default="scope">
                        <el-button size="default" type="danger" @click="deleteItem(scope.$index)">删除</el-button>
                        <el-button size="default" type="primary" @click="callUser(scope.row)">联系客户</el-button>            
                    </template>     
                </el-table-column>
                <el-table-column
                label="支付方式"
